...
namespace NearFutureElectrical.UI
{
  public class UIResources
  {
    ...
    private void CreateIconList()
    {
      ...
      iconList.Add("reactor_basic", new AtlasIcon(generalIcons, 0.0f, 0.0f, 0.25f, 0.25f));
      iconList.Add("reactor_large", new AtlasIcon(generalIcons, 0.0f, 0.0f, 0.25f, 0.25f));
      iconList.Add("reactor_plant", new AtlasIcon(generalIcons, 0.0f, 0.0f, 0.25f, 0.25f));
